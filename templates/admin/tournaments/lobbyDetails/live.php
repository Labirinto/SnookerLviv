...
if(count($data) > 0)
{
	...
	for($i = 0; $i < count($data); $i++)
	{
		...
		printLiveMatch($counter, $player1, $score1, $points1, $break1, $player2, $score2, $points2, $break2, $bestOf);
	}
}
else
{
...
<div class="list-match-lobby-player">
	...
	<p>
		<img class="list-match-lobby-player-img" alt="img" src="<?=$img?>">
	</p>
</div>
...
function printLiveMatch($matchNum, $player1, $score1, $points1, $break1, $player2, $score2, $points2, $break2, $bestOf)
{ ?>
   ...
   <div class="list-match-lobby-table">
		...
		<div class="list-match-lobby-player-table">
			<?php printPlayer($player1, "../../img/lev.jpg"); ?>
			...
			<?php printPlayer($player2, "../../img/dan02.jpg"); ?>
		</div>
	</div>
	</br>
