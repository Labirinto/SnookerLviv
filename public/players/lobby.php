<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "GET")
	{
		...
		render("players/lobby.php", ["title"=>$lName." ".$fName, "fName"=>$fName, "lName"=>$lName, "img"=>$img, "playerID"=>$playerID, "birthday"=>$birthday, "highestBreak"=>$highestBreak, "tournamentCtr"=>$tournamentCtr, "breakCtr"=>$breakCtr]);
	}
	else
	{
		redirect("");
